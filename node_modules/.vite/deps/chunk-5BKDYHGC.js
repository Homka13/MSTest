...
var PlatformAuthInteractionClient = class extends BaseInteractionClient {
  ...
  async generateAuthenticationResult(response, request, idTokenClaims, accountEntity, authority, reqTimestamp) {
    ...
    const result = {
      ...
      ...((_b = request.extraParameters) == null ? void 0 : _b.resource) && {
  ...
  async cacheNativeTokens(response, request, homeAccountIdentifier, idTokenClaims, tenantId, reqTimestamp, environment, storeInCache) {
    ...
    if (!!cachedIdToken && (storeInCache == null ? void 0 : storeInCache.idToken) !== false) {
  ...
  async initializePlatformRequest(request) {
    ...
    const validatedRequest = {
      ...
      extraParameters: {
        ...
        // resource is set for MCP scenarios
      },
  ...
  handleExtraBrokerParams(request, embeddedClientId) {
    ...
    const {
      ...
      [AADServerParamKeys_exports.BROKER_CLIENT_ID]: _brkClientId,
      // eslint-disable-next-line @typescript-eslint/no-unused-vars
      [AADServerParamKeys_exports.BROKER_REDIRECT_URI]: _brkRedirectUri,
      // eslint-disable-next-line @typescript-eslint/no-unused-vars
      [AADServerParamKeys_exports.CLIENT_ID]: _clientId,
...
var FetchClient = class {
  ...
  async sendPostRequestAsync(url, options) {
    ...
    const reqHeaders = getFetchHeaders(options);
    const correlationId = options == null ? void 0 : options.correlationId;
    const performanceClient = options == null ? void 0 : options.performanceClient;
    let response;
    let lastError;
    for (let attempt = 1; attempt <= MAX_FETCH_POST_RETRIES + 1; attempt++) {
      try {
        ...
        if (correlationId) {
          performanceClient == null ? void 0 : performanceClient.incrementFields({ fetchRetryCount: 1 }, correlationId);
        }
      }
    }
    if (!response) {
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-IG5U3A2M.js");
    }
  } catch (e) {
  }
  return void 0;
...
*/
//# sourceMappingURL=chunk-5BKDYHGC.js.map
